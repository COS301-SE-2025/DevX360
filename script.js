...
function checkAuth() {
  ...
  console.log('Checking auth. Has session:', !!hasSession, 'Current page:', currentPage);
  
  if (hasSession && (currentPage.includes('index.html') || currentPage === '/')) {
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  ['mousemove', 'mousedown', 'touchstart', 'click', 'keypress'].forEach(event => {
  ...
  const signupLink = document.querySelector('.auth-footer a[onclick*="signup"]');
  const signinLink = document.querySelector('.auth-footer a[onclick*="signin"]');
