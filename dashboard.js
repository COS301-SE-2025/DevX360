...
/*function setupNavigation() {
  ...
  navItems.forEach((item) => {
    item.addEventListener("click", function (e) {
      ...
      if (!section) {
        // No section means it's a real link like href="profile.html" — allow navigation
        return;
      }

      // Otherwise, prevent default and toggle sections
      e.preventDefault();
...
/*async function loadAvatar(email) {
  try {
    ...
    document.getElementById("profile-avatar-image").src =
      "https://via.placeholder.com/150";
  }
}*/
