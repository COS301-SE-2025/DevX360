      ...
      <div className="min-h-screen bg-[var(--bg)]">
                ...
                <div className="bg-[var(--bg-container)] rounded-xl shadow-sm border border-[var(--border)] overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-[var(--border)]">{filteredUsers.length > 0 ? filteredUsers.map(user => (
                ...
                <div className="bg-[var(--bg-container)] rounded-xl shadow-sm border border-[var(--border)] overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-[var(--border)]">{filteredTeams.length > 0 ? filteredTeams.map(team => (
        ...
        {showDeleteModal && (
            <DeleteConfirmationModal
                type={teamToDelete ? "team" : "user"}
                name={teamToDelete?.name || userToDelete?.name}
                onConfirm={teamToDelete ? confirmDeleteTeam : confirmDeleteUser}
                onCloseDelete={() => {
                  setShowDeleteModal(false);
                  setTeamToDelete(null);
                  setUserToDelete(null);
                }}
                isDeleting={teamToDelete ? isDeletingTeam : isDeleting}
            />
        )}
      </div>
  );
