                  ...
                  <table className="w-full">
                    ...
                    {filteredTeams.length > 0 ? filteredTeams.map(team => (
                        <tr key={team._id} className="hover:bg-[var(--bg)] transition-colors duration-200">
                          ...
                          {/*<td className="px-6 py-4">
                            {team.repoUrl ? (
                                <div className="flex items-center space-x-2 -ml-px">
                                  <Github className="w-4 h-4 text-[var(--text-light)]" />
                                  <a
                                      href={team.repoUrl}
                                      target="_blank"
                                  ...
                                  >
                                    {team.repoUrl.split('github.com/')[1]}
                                  </a>
                                </div>
                            ) : (
                                <span className="text-sm text-[var(--text-light)] italic">No repository linked</span>
                            )}
                          </td>*/}
                          {/*<td className="px-6 py-4">
                            <div className="flex items-center space-x-2">
                              <Calendar className="w-4 h-4 text-[var(--text-light)]" />
                              <span className="text-sm text-[var(--text)]">{formatDate(team.createdAt)}</span>
                            </div>
                          </td>*/}
                          <td className="px-6 py-4">
                            <div className="flex items-center justify-end space-x-2">
