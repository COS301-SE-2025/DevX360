...
import CreateTeamModal from "./modal/CreateTeam";
import JoinTeamModal from "./modal/JoinTeam";
import ModalPortal from "./modal/ModalPortal"; // Import the portal wrapper
import {getMyTeams} from "../../services/profile";
...
function Team() {
    ...
    return (
        <div>
            ...
            {/* Modals wrapped in Portal - these will render at document root */}
